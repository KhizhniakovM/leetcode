...
class ParkingSystem {
  final Map<int, int> _capacityHolder;
  final Map<int, int> _currentCountHolder = {1: 0, 2: 0, 3: 0};

  ParkingSystem(int big, int medium, int small)
      : _capacityHolder = {1: big, 2: medium, 3: small};

  bool addCar(int carType) {
    if (_currentCountHolder[carType]! < _capacityHolder[carType]!) {
      _currentCountHolder[carType] = _currentCountHolder[carType]! + 1;
      return true;
    }
    return false;
  }
