...
class UndergroundSystem {
  final Map<String, Map<String, List<int>>> _average = {};
  final Map<int, (String, int)> _person = {};

  void checkIn(int id, String stationName, int t) {
    _person[id] = (stationName, t);
  }

  void checkOut(int id, String stationName, int t) {
    final start = _person[id]!;
    final time = t - start.$2;
  ...
  double getAverageTime(String startStation, String endStation) {
    final list = _average[startStation]![endStation]!;
    final sum = list.fold(0, (prev, cur) => prev + cur);
