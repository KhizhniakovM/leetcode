import 'package:leetcode/array/medium/2001.number_of_pairs_of_interchangeable_rectangles.dart';
import 'package:test/test.dart';

void main() => group('number_of_pairs_of_interchangeable_rectangels', () {
      final f = Solution().interchangeableRectangles;

      test('f([[4,8],[3,6],[10,20],[15,30]])', () {
        expect(
          f([
            [4, 8],
            [3, 6],
      ...
      test('f([[1,7],[2,8],[8,8],[2,5],[2,8],[7,4]])', () {
        expect(
          f([
            [1, 7],
            [2, 8],
